...
const autoprefixer = require("autoprefixer"); /* Совместимость со старыми браузерами дбля цсс */
...
function styles() {
    return src(["src/sass/main.+(scss|sass)"]) /* Где искать файл */
        ...
        .pipe(postcss([autoprefixer()])) /* { overrideBrowserslist: ["last 10 version"], grid: true } */
...
function scripts() {
    return src("src/js/main.js")
        ...
        .pipe(dest("src/assets/js")) /* Куда сохранить  */
        .pipe(browserSync.stream()); /* Аналог лайв сервер */
}
...
exports.build = series(cleanDist, images, html, scriptsProd, copyAssets, build);
