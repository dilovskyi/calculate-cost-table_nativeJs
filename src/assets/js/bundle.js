...
document.addEventListener("DOMContentLoaded", function () {
  var addHeaderShadow = function addHeaderShadow() {
  ...
  var toggleCurrency = function toggleCurrency() {
    var labels = document.querySelectorAll(".prices__input-panel-currency-item label");
  ...
  var tableServices = function tableServices() {
    var totalSum = document.querySelector(".prices__resume-total-sum span");
    var tableTotal = 0;
    document.querySelectorAll(".prices__table-row").forEach(function (item) {
      ...
      item.addEventListener("click", function (e) {
        if (e.target.parentNode.classList.contains("prices__table-row-cell")) {
          ...
          var clickedPrice = +clickedSpan.innerHTML.replace(/\D/gm, ""); // get price from span content

          var clickedInput = clickedSpan.nextElementSibling;
          var inputName = clickedInput.getAttribute("name");
          var clickedInputGroup = document.querySelectorAll("[name=\"".concat(inputName, "\"]"));
          var rowPrice = clickedPrice;
          var prevPrice = 0; //Получить актуальную цену из ряда

          clickedInputGroup.forEach(function (item) {
